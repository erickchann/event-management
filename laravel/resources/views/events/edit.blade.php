        ...
        <form class="needs-validation" novalidate action="/events/{{ $event->id }}" method="POST">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : ''}}" id="inputName" name="name" placeholder="" value="{{ $event->name }}">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : ''}}" id="inputSlug" name="slug" placeholder="" value="{{ $event->slug }}">
