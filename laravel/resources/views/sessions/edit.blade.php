...
@section('content')
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form class="needs-validation" novalidate action="/events/{{ $event->id }}/sessions/{{ $session->id }}" method="POST">
            @csrf
            @method('put')
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : ''}}" id="textareaDescription" name="description" placeholder="" rows="5">{{ $session->description }}</textarea>
